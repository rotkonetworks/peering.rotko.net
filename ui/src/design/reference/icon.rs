...
pub const OIDC: Asset = asset!("/resources/icon/oidc.svg");
pub const MENU: Asset = asset!("/resources/icon/menu.svg");
pub const SEARCH: Asset = asset!("/resources/icon/search.svg");
